...
const piConfigName: string | undefined = pkg.piConfig?.name; export const 
PACKAGE_NAME: string = pkg.name || "@earendil-works/pi-coding-agent"; export 
const APP_NAME: string = piConfigName || "AIDAST"; export const APP_TITLE: 
string = piConfigName ? APP_NAME : "AIDAST"; export const CONFIG_DIR_NAME: 
string = pkg.piConfig?.configDir || ".aidast"; export const VERSION: string = 
pkg.version || "0.0.0";
