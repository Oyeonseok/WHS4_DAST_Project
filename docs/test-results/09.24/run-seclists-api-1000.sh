...
.venv/bin/python docs/test-results/09.24/prepare_juice_scope_1000.py
.venv/bin/python -m aidast recon https://lab.aidast.invalid/juice-shop \
  --output-dir result/test-runs/09.24/seclists-api-1000/Scope \
  ...
  --db-path result/test-runs/09.24/seclists-api-1000/Recon.db \
  --surface-path result/test-runs/09.24/seclists-api-1000/Surface.json \
  --diagnostic-logs \
  --execute
