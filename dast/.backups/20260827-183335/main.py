...
class GroundingError(MainAgentError):
    """Codex returned an asset or quote that is not verbatim present in the
    captured page text. Carries the ungrounded page and analysis so callers
    can persist a debug capture before failing closed."""

    def __init__(
        self, message: str, *, page: ProgramPage, analysis: ScopeAnalysis
    ) -> None:
