---
name: aidast-validation-graphql
description: Interpret bounded hunt-graphql replay evidence and impact without authorizing requests or choosing the final status.
---

# hunt-graphql validation
...
a GraphQL query or mutation crosses the declared field, role, or operation boundary
