---
name: aidast-validation-source-leak
description: Interpret bounded hunt-source-leak replay evidence and impact without authorizing requests or choosing the final status.
---

# hunt-source-leak validation
...
the response contains the declared source, map, credential-pattern, or internal-code marker
