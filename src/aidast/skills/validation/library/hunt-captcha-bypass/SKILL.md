---
name: aidast-validation-captcha-bypass
description: Interpret bounded hunt-captcha-bypass replay evidence and impact without authorizing requests or choosing the final status.
---

# hunt-captcha-bypass validation
...
a challenge-protected action succeeds without a valid fresh challenge
