---
name: aidast-validation-html-injection
description: Interpret bounded hunt-html-injection replay evidence and impact without authorizing requests or choosing the final status.
---

# hunt-html-injection validation
...
the unique marker is parsed into the declared HTML node or attribute context
...
- Boundary: identify the origin, user-interaction, or victim-context boundary required by the browser effect
- Sensitivity: distinguish inert markup from script execution or a sensitive UI action
- Actor requirements: score required delivery, victim interaction, and authentication state
