---
name: aidast-validation-dispatch
description: Interpret bounded hunt-dispatch replay evidence and impact without authorizing requests or choosing the final status.
---

# hunt-dispatch validation
...
the dispatcher routes attacker-controlled input to an unintended handler or capability
