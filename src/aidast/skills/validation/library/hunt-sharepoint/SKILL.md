---
name: aidast-validation-sharepoint
description: Interpret bounded hunt-sharepoint replay evidence and impact without authorizing requests or choosing the final status.
---

# hunt-sharepoint validation
