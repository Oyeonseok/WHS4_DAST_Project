---
name: aidast-validation-ntlm-info
description: Interpret bounded hunt-ntlm-info replay evidence and impact without authorizing requests or choosing the final status.
---

# hunt-ntlm-info validation
...
the controlled callback endpoint receives the declared NTLM authentication attempt
