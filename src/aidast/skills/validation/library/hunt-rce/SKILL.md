---
name: aidast-validation-rce
description: Interpret bounded hunt-rce replay evidence and impact without authorizing requests or choosing the final status.
---
...
crafted input produces the declared isolated command-execution marker or runtime-specific execution signal
