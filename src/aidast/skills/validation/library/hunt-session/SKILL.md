---
name: aidast-validation-session
description: Interpret bounded hunt-session replay evidence and impact without authorizing requests or choosing the final status.
---

# hunt-session validation
...
a session token remains usable across the declared logout, rotation, identity, or scope boundary
