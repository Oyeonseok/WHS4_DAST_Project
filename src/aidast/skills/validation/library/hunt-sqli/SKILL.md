---
name: aidast-validation-sqli
description: Interpret bounded hunt-sqli replay evidence and impact without authorizing requests or choosing the final status.
---

# hunt-sqli validation
...
crafted input produces a database-specific parsing signal or controlled query-result change
