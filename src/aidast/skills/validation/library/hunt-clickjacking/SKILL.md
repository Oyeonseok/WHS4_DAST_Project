---
name: aidast-validation-clickjacking
description: Interpret bounded hunt-clickjacking replay evidence and impact without authorizing requests or choosing the final status.
---

# hunt-clickjacking validation
...
a framed page permits activation of the declared sensitive UI action
