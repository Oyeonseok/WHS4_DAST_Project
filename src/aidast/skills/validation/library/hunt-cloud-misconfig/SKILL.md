---
name: aidast-validation-cloud-misconfig
description: Interpret bounded hunt-cloud-misconfig replay evidence and impact without authorizing requests or choosing the final status.
---

# hunt-cloud-misconfig validation
...
a cloud resource or control-plane capability is reachable beyond its intended principal
