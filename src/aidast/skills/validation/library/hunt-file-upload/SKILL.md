---
name: aidast-validation-file-upload
description: Interpret bounded hunt-file-upload replay evidence and impact without authorizing requests or choosing the final status.
---

# hunt-file-upload validation
...
the uploaded test artifact reaches the prohibited storage, parsing, or execution state
...
- Boundary: identify whose resource or protected workflow accepted the state transition
- Sensitivity: cite the durable effect and whether it is reversible within the test fixture
- Actor requirements: score the minimum role, interaction, and timing prerequisites
