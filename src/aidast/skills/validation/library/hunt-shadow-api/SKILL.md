---
name: aidast-validation-shadow-api
description: Interpret bounded hunt-shadow-api replay evidence and impact without authorizing requests or choosing the final status.
---

# hunt-shadow-api validation
...
an undocumented API route exposes the declared protected data or operation
