---
name: aidast-validation-business-logic
description: Interpret bounded hunt-business-logic replay evidence and impact without authorizing requests or choosing the final status.
---

# hunt-business-logic validation
...
the prohibited business transition is durably committed
