---
name: aidast-validation-xss
description: Interpret bounded hunt-xss replay evidence and impact without authorizing requests or choosing the final status.
---
...
the unique marker executes in the target origin and declared browser context
