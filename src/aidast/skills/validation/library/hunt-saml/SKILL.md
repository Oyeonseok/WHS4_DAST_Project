---
name: aidast-validation-saml
description: Interpret bounded hunt-saml replay evidence and impact without authorizing requests or choosing the final status.
---

# hunt-saml validation
...
a modified or policy-invalid assertion establishes the protected identity or role
