---
name: aidast-validation-nosqli
description: Interpret bounded hunt-nosqli replay evidence and impact without authorizing requests or choosing the final status.
---

# hunt-nosqli validation
...
crafted input produces a datastore-specific error or unauthorized query-result change
