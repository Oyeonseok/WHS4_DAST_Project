---
name: aidast-validation-cors
description: Interpret bounded hunt-cors replay evidence and impact without authorizing requests or choosing the final status.
---

# hunt-cors validation
...
a credentialed cross-origin reader can access the declared protected response
