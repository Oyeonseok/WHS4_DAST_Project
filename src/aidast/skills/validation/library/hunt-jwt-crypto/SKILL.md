---
name: aidast-validation-jwt-crypto
description: Interpret bounded hunt-jwt-crypto replay evidence and impact without authorizing requests or choosing the final status.
---

# hunt-jwt-crypto validation
...
a cryptographically invalid or policy-forbidden token is accepted for the protected operation
