---
name: aidast-validation-ato
description: Interpret bounded hunt-ato replay evidence and impact without authorizing requests or choosing the final status.
---
...
an attacker-controlled flow changes control of the victim test account
