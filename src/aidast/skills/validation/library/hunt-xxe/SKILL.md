---
name: aidast-validation-xxe
description: Interpret bounded hunt-xxe replay evidence and impact without authorizing requests or choosing the final status.
---
...
the controlled callback or local marker proves external entity resolution
