---
name: aidast-validation-api-misconfig
description: Interpret bounded hunt-api-misconfig replay evidence and impact without authorizing requests or choosing the final status.
---

# hunt-api-misconfig validation
...
unauthorized API capability or sensitive metadata becomes reachable
