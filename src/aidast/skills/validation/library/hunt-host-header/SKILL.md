---
name: aidast-validation-host-header
description: Interpret bounded hunt-host-header replay evidence and impact without authorizing requests or choosing the final status.
---

# hunt-host-header validation
...
a controlled Host value changes a security-sensitive absolute URL, routing, or trust decision
