---
name: aidast-validation-open-redirect
description: Interpret bounded hunt-open-redirect replay evidence and impact without authorizing requests or choosing the final status.
---

# hunt-open-redirect validation
...
the application emits or follows an external redirect to the controlled destination
