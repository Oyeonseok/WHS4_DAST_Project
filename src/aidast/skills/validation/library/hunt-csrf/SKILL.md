---
name: aidast-validation-csrf
description: Interpret bounded hunt-csrf replay evidence and impact without authorizing requests or choosing the final status.
---

# hunt-csrf validation
...
a cross-site request causes the declared authenticated state change
