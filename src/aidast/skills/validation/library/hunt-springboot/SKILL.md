---
name: aidast-validation-springboot
description: Interpret bounded hunt-springboot replay evidence and impact without authorizing requests or choosing the final status.
---

# hunt-springboot validation
...
a Spring Boot actuator, diagnostic, or framework endpoint exposes the declared protected effect
