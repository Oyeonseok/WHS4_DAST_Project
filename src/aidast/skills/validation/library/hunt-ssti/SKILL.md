---
name: aidast-validation-ssti
description: Interpret bounded hunt-ssti replay evidence and impact without authorizing requests or choosing the final status.
---

# hunt-ssti validation
...
template input produces a template-engine-specific evaluation result or isolated expression marker
