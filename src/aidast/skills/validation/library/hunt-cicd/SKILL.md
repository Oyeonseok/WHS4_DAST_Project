---
name: aidast-validation-cicd
description: Interpret bounded hunt-cicd replay evidence and impact without authorizing requests or choosing the final status.
---

# hunt-cicd validation
...
CI/CD metadata, secret material, or an unauthorized pipeline action becomes reachable
