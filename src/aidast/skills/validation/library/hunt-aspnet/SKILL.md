---
name: aidast-validation-aspnet
description: Interpret bounded hunt-aspnet replay evidence and impact without authorizing requests or choosing the final status.
---

# hunt-aspnet validation
...
ASP.NET diagnostic, configuration, or framework-specific protected data is exposed
