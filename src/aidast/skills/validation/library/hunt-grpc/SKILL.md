---
name: aidast-validation-grpc
description: Interpret bounded hunt-grpc replay evidence and impact without authorizing requests or choosing the final status.
---

# hunt-grpc validation
...
a gRPC method exposes a protected result or framework-specific failure across the declared boundary
