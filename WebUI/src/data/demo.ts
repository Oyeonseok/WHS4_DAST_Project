...
export function demoSnapshot(): Snapshot {
  return {
    ...
    logs: [
      { id: 1, time: '2026-09-20T05:28:00Z', stage: 'Scope', level: 'success', message: 'Demo Scope and approval hashes match. Only synthetic lab data is used.' },
      { id: 2, time: '2026-09-20T05:28:04Z', stage: 'Recon', level: 'success', message: 'Demo asset inventory finalized · 218 Recon.db paths' },
      { id: 3, time: '2026-09-20T05:28:09Z', stage: 'Recon', level: 'info', message: 'Handoff.json provenance verified · Pipeline.db created' },
      { id: 4, time: '2026-09-20T05:28:12Z', stage: 'Attack', level: 'info', message: 'Access control template batch started · task 84 of 136' },
      ...
      { id: 7, time: '2026-09-20T05:28:24Z', stage: 'Attack', level: 'info', message: 'F-0042 added to review queue · matcher result alone is not a verdict' },
    ],
  };
}
